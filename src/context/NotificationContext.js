...
export const NotificationProvider = ({ children }) => {
  ...
  useEffect(() => {
    console.log('📱 Setting up notification Socket.IO listeners...');

    // Listen for CV view notifications
    const handleCVViewed = data => {
      console.log('👁️ CV viewed notification received:', data);
      addNotification({
        type: 'cv_viewed',
    ...
    const handleCVAccessRequest = () => {
      console.log('📋 CV access request - refreshing notifications');
      fetchNotifications();
    };
    ...
    console.log('✅ Notification Socket.IO listeners registered');
